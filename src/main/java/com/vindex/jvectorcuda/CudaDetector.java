...
/**
 * Utility class for detecting CUDA availability and validating GPU capabilities.
 *
 * <p>This class checks whether the system has a compatible NVIDIA GPU and CUDA
 ...
 * <p>JVectorCUDA uses PTX (Portable Intermediate Representation) which is
 ...
 * <table border="1">
 *   <tr><th>GPU Generation</th><th>Compute</th><th>Examples</th><th>Supported</th></tr>
 *   <tr><td>Pascal</td><td>6.1</td><td>GTX 1060/1070/1080</td><td>Yes</td></tr>
 *   <tr><td>Volta</td><td>7.0</td><td>Tesla V100</td><td>Yes</td></tr>
 *   <tr><td>Turing</td><td>7.5</td><td>RTX 2080, Tesla T4</td><td>Yes</td></tr>
 *   <tr><td>Ampere</td><td>8.0/8.6</td><td>A100, RTX 3090</td><td>Yes</td></tr>
 *   <tr><td>Ada Lovelace</td><td>8.9</td><td>RTX 4090</td><td>Yes</td></tr>
 *   <tr><td>Maxwell</td><td>5.x</td><td>GTX 980</td><td>No</td></tr>
 * </table>
 *
 * <h2>Usage</h2>
 * <pre>{@code
 ...
 * <p>If {@link #isAvailable()} returns false:
 * <ol>
 *   <li>Verify NVIDIA GPU is installed: {@code nvidia-smi}</li>
 *   <li>Check driver version: {@code nvidia-smi} (top right shows CUDA version)</li>
 *   <li>Update drivers if below 11.8: <a href="https://www.nvidia.com/drivers">nvidia.com/drivers</a></li>
...
public final class CudaDetector {
     ...
     *
     * <p>Note: This is the driver version, not the CUDA Toolkit version.
     ...
     *
     * <p>Format: "GPU Name (Compute X.Y, XXXX MB VRAM, XXXX MHz)"
     *
     ...
     *
     * <p>Includes: name, compute capability, VRAM, clock rate, multiprocessors,
     ...
     *
     * <p>Includes driver version, compute capability, and compatibility status.
